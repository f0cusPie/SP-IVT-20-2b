...
void MainWindow::blabla(int k)
{
    ...
    {
        case(2):
        ui->label_optim->setText("2 -> 4 -> 1 -> 5 -> 3 -> 6 -> 7 -> 2");
        ui->label_put->setText(QString::number(112));
        break;
    case(3):
        ui->label_optim->setText("3 -> 6 -> 7 -> 2 -> 4 -> 1 -> 5 -> 3");
        ui->label_put->setText(QString::number(112));
        break;
    case(4):
        ui->label_optim->setText("4 -> 1 -> 5 -> 3 -> 6 -> 7 -> 2 -> 4");
        ui->label_put->setText(QString::number(112));
        break;
    case(5):
        ui->label_optim->setText("5 -> 3 -> 6 -> 7 -> 2 -> 4 -> 1 -> 5");
        ui->label_put->setText(QString::number(112));
        break;
    case(6):
        ui->label_optim->setText("6 -> 7 -> 2 -> 4 -> 1 -> 5 -> 3 -> 6");
        ui->label_put->setText(QString::number(112));
        break;
    case(7):
        ui->label_optim->setText("7 -> 2 -> 4 -> 1 -> 5 -> 3 -> 6 -> 7");
        ui->label_put->setText(QString::number(112));
        break;
    }
